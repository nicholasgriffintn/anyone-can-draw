...
const App = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-slate-900 overflow-hidden">
      <header className="border-b border-slate-700 bg-slate-800 flex-shrink-0 shadow-md">
        <div className="px-4 py-4 flex items-center justify-between">
          ...
          {app.githubRepo && (
            <a
              ...
              className="text-sm text-white bg-purple-600 px-4 py-2 rounded-lg hover:bg-purple-700 border border-purple-500 transition-all"
            >
              View source
            </a>
          )}
