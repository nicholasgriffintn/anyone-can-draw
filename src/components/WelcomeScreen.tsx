...
const WelcomeScreen: FC<WelcomeScreenProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 space-y-6">
      <h1 className="text-3xl font-bold text-blue-600">Welcome to Anyone Can Draw</h1>
      <p className="text-gray-600">
        A game where you play against others and AI to get the highest score guessing what others drew.
      </p>
