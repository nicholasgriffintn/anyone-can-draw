    ...
    <>
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm font-medium text-purple-400 bg-purple-900/50 px-2 py-0.5 rounded-full">{lineWidth}px</span>
        </div>
      ...
      <div className="p-4 border-2 border-slate-700 rounded-xl bg-slate-700/50">
        ...
        <div className="w-full h-[2px] bg-slate-600 rounded-full" />
        <div
